...
async def cmd_start(message: types.Message, state: FSMContext):
    ...
    if not is_sub:
        ...
        # ЛОГИКА ДЛЯ ПОДПИСЧИКОВ: Отправляем LOGO_NAVIGATOR_URL
...
async def get_guide_cb(cb: types.CallbackQuery):
    # Проверка наличия отчета (в базе или кэше) - здесь упрощенно кэш
    # Для полной реализации с Firestore нужно добавить проверку get_diagnostic
