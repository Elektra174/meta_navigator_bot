...
QUESTIONS = [
    "Где и в чем конкретно в вашей жизни сейчас основной затык, застой или где и как вы сейчас буксуете?",
    "Представьте, что завтра утром произошло чудо. Проблема, затык или застой, исчезли. Как вы это поймете? Что конкретно изменится в вашем поведении и ощущениях?",
    ...
    "Что вас больше всего бесит/раздражает в других людях? Какое качество или поведение вызывает самую сильную эмоциональную реакцию?",
...
async def start_audit_flow(callback: types.CallbackQuery, state: FSMContext):
    ...
    try:
        ...
        await callback.message.answer(
            ...
            f"В течение следующих {len(QUESTIONS)} шагов мы проведем диагностику ваших внутренних программ. "
