...
QUESTIONS = [
    ...
    "4. Когда вы направляете внимание на этот образ, что вы замечаете в теле? Это может быть сжатие, тяжесть, холод или какое-то иное ощущение?",
    ...
    "6. Как вам кажется, сколько еще времени вы готовы нарезать круги по этому старому маршруту (этой «петле»), пока ваш внутренний ресурс не иссякнет?",
    "7. Готовы ли вы прямо сейчас попробовать перехватить управление у «Автопилота» и проложить свой собственный маршрут из точки ясности?"
]
...
2. Тон: Бережный, мудрый. Разъясняй термины:
   - Застойная доминанта: как внутренний магнит в мозгу, стягивающий вашу энергию.
